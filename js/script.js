...
const quotes = [
  ...
  },
  {
      ...
      year: "1898",
      type: "letter - Letter to Bernard Berenson"
  },
  {
      ...
      year: "2013",
      type: "song - Vacation Bible School"
  },
];
...
function printQuote(arr) {
  ...
  let html =  `<p class="quote"> ${quoter.quote}  </p>`;
  ...
  if (quoter.type !== null) {
    html += `<span class="type"> ${quoter.type} </span>`
}
